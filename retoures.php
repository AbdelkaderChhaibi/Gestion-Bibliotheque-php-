...
<html>
<head>
	<title>retour reservation</title>
...
$sql2=mysqli_query($mysqli,"DELETE FROM reservation where id ='$idr'");
$sql3=mysqli_query($mysqli,"UPDATE livre set reserver='' where title='$title' ");
$sql4=mysqli_query($mysqli,"UPDATE adherant set nbrlivre=nbrlivre-1 where matricule='$mat'");
$sql5=mysqli_query($mysqli,"UPDATE livre set dispo=1 where title='$title' ");

echo "<div class='container'>
		<div class='col-md-6 col-md-offset-3'>
			<div class='alert alert-danger'>
		<h5  style='text-align: center;' > le retour de livre faire avec succè  </h5><br><br>
		<hr>
