...
$sql2=mysqli_query($mysqli,"UPDATE adherant set nbrlivre=nbrlivre-1 where matricule ='$mat' ");
$sql3=mysqli_query($mysqli,"DELETE from reservation where id='$idr' ");
echo "<div class='container'>
		<div class='col-md-6 col-md-offset-3'>
			<div class='alert alert-danger'>
		<h5  style='text-align: center;' > reservation est refuser et supprimer </h5><br><br>
		<hr>
