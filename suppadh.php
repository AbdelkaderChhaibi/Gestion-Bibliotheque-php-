...
<body background="images/b.jpg">
	...
	if(isset($_SESSION['valid'])){
		...
		$code = $_GET['id'];
		$sql=mysqli_query($mysqli,"DELETE FROM adherant WHERE id='$code'");
?>
...
<div class='container'>
		...
		<h5  style='text-align: center;' >suppression avec succés</h5><br><br>
		<hr>

		<a href='g_adherant.php'><h3 style='text-align: center;'>retour</h3></a>
	</div></div></div>
